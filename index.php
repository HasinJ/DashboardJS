...
//hello world
$hi = "hello, here are the used data points: $limit";
echo "$hi <br>" ;

//how much data to display as echo, and initial set of data points for dynamic-ish chart
...
<html lang="en">
  ...
  <body>
    <div class = "col-md-10 offset-md-1">
      <h1 align = "center">FoxChase (second column)</h1>
